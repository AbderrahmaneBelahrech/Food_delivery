...
CREATE TABLE `meal_ingredients` (
  ...
  KEY `FK7tv2uim7o1ri1052b065mifya` (`meal_id`),
  CONSTRAINT `FK7tv2uim7o1ri1052b065mifya` FOREIGN KEY (`meal_id`) REFERENCES `meal` (`id`)
...
INSERT INTO `meal_ingredients` VALUES (1,'Courgettes'),(1,'Aubergines'),(1,'Poivrons'),(1,'Tomates'),(1,'Herbes de Provence'),(2,'spaghetti'),(2,'egg'),(2,'cheese'),(2,'pancetta'),(2,'pepper');
